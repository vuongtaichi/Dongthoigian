...
const chapters = [
  ...
  },
  {
    ...
    intro: [
      "Là một trong 22 đại biểu của c4 đi dự đại hội liên chi đoàn d2. Ngày đại hội khá buồn ngủ, nhiều thủ tục, và nhiều văn bản giống như những buổi đại hội thời học sinh. Cuối buổi đại hội được thông báo mình là 1 trong 17 đại biểu sẽ tham dự đại hội liên chi đoàn cấp cơ sở (bên Trung đoàn). Thấy sĩ phết vì là chiến sĩ mới duy nhất."
    ]
  },
  {
    id: "ch-26",
    ...
    intro: [
      "Hôm nay là buổi tối thứ 7 đầu tiên mình ra ngoài sân đại đội để xem ti vi, mọi ngày toàn ngồi trong phòng viết sổ. Buổi đầu tiên xem đúng vào hôm trời rét, cả đám co ro ngồi xúm lại gần nhau trước màn hình ti vi. Phim không tệ, xem cũng làm mình thay đổi không khí một chút, không cần vùi đầu vào sổ sách cả tối lẫn ngày. Lâu lâu thay đổi không khí một chút để thêm trải nghiệm đời lính, không phải lúc nào cũng chỉ có huấn luyện và chồng sổ sách giáo án.",
      "Thứ 2 bắn đạn thật nội dung đứng bắn, c4 bắn đầu và b1 là trung đội mở bát cho cả tiểu đoàn. Nghe thôi đã đầy áp lực! Khả năng cao ngày mai sẽ học bắn súng để ôn luyện. Hy vọng kết quả lần này không quá tệ.",
  ...
  },
  {
    ...
    intro: [
      "9 ngày chưa viết nhật ký. Sau khi thi xong 3 tiếng nổ lại lao vào các hoạt động mới, buổi tối mệt rã người, đặt lưng xuống giường là muốn ngủ ngay. Đang viết những dòng này vào một buổi trưa oi nóng, ve đang râm ran như chạy trận ngoài kia, vừa mới giặt bộ k03 xong.",
  ...
  },
  {
    ...
    intro: [
      ...
      "Buổi sáng đổi tập sang mắc tăng võng vì hôm trước đã tập băng bó. Ngày hôm nay được tập ở nhà nên thấy yên tâm vì chỉ cần mọi người lên là có thể chạy ra ngay. Lẽ ra lúc này đang ở bên trung đoàn để dự đại hội trù bị, nhưng chỉ những ai phát biểu mới phải ở lại nên mình được về tiểu đoàn sớm. Đang mắc tăng võng thì trời bắt đầu lất phất mưa, mẹ và mọi người cũng vừa đến, đang đợi ngoài cổng. Trong lòng thấp thỏm vô cùng! Ngồi tập bên đường nhìn ra thấy hàng đoàn người từ ngoài cổng nhìn vào. Hôm nay có rất nhiều người gọi người nhà lên thăm, bên ngoài đã không còn nhìn thấy đường đi nữa. Trong hàng người đó mình nhìn thấy mẹ và mọi người. Chỉ tầm trăm mét mà cảm giác cách nhau thật xa.",
  ...
  },
  {
    ...
    intro: [
      ...
      "3 tháng tân binh cứ như vậy mà kết thúc, giờ chỉ còn đợi biên chế đi đơn vị mới nữa thôi. Tạm thời kết thúc những ngày tháng nắng gió đầy mỏi mệt. Giờ ngồi nghĩ lại toàn bộ quá trình huấn luyện mà vẫn thấy rùng mình, không hiểu sao mình có thể vượt qua được khoảng thời gian đó."
    ],
    ps: [
  ...
  },
  {
    ...
    intro: [
      ...
      "Chiều nay máy nghe nhạc đã tới nơi, rất hợp với ý mình. Kịp copy ít nhạc với mấy bài nghe tiếng anh. Tối nay sẽ bắt đầu trải nghiệm. Háo hức!!!"
    ],
  ...
  },
  {
    ...
    intro: [
      ...
      "Buổi chiều sau khi quay lại Sư đoàn để thu dọn trại triển lãm thì cùng mọi người về d2, quay lại với cuộc sống thường ngày ở bTT. Chờ đến cuối tháng sau để lên Quân khu dự đại hội. Trên đó chắc chắn là không thể gặp được bạn cũ nữa rồi."
    ]
  },
  {
    id: "ch-55",
